...
model_name = f"{model_dir}/Qwen-Image-2512"
...
pipe = QwenImagePipeline.from_pretrained(model_name, torch_dtype=torch_dtype, transformer=transformer)
...
image.save("/home/tonera/website/output/test_qwen_2512.png")
