...
export const GLOBAL_CONFIG_FIELDS: ConfigFieldDef[] = [
  ...
  { path: 'loras_dir', type: 'string', labelKey: 'fields.lorasDir' },
  {
    ...
    options: ['local', 'server', 's3', 'oss', 'r2'],
  },
  ...
  { path: 'storage.r2.endpoint', type: 'string', labelKey: 'fields.storageR2Endpoint' },
  { path: 'storage.r2.region', type: 'string', labelKey: 'fields.storageR2Region' },
  { path: 'storage.r2.bucket', type: 'string', labelKey: 'fields.storageR2Bucket' },
  { path: 'storage.r2.access_key_id', type: 'string', labelKey: 'fields.storageR2AccessKeyId' },
  { path: 'storage.r2.secret_access_key', type: 'password', labelKey: 'fields.storageR2SecretAccessKey' },
  { path: 'storage.r2.public_base_url', type: 'string', labelKey: 'fields.storageR2PublicBaseUrl' },
